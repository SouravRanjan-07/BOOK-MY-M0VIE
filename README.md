...
Welcome to the **BookMyScreen** a **full-stack movie ticket booking system** using **React**, **Node.js**, **MongoDB**, and **Express.js**.
...
- **Grouped Showtimes by Location & Theatre**
...
- **Deployment:** Render / Vercel _(Optional)_
